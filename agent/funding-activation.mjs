...
export function fundingActivationPlanMain() {
  const required = ["manifest", "authorization", "activation-signatures", "trust-registry", "artifact-root", "sp1-security-report", "rpc-operator-registry", "rpc-registry-trusted-root", "primary-rpc", "secondary-rpc", "primary-rpc-operator-id", "secondary-rpc-operator-id", "python", "repo-root", "output"];
