...
- [x] A required-check CI run passes for exact merged source release `e54d116f3eebec0e4afba8dea179a8626d42ed35` ([run 29147959791](https://github.com/techno-optimist/p42-prizes/actions/runs/29147959791)); each later source merge must earn its own successful push run before release.
...
- Local verification covers problem validation, certified-path exactness lint, Python tests, seed verification, contracts, agent, web typecheck/tests/build, and package audits. GitHub Actions is published; [`main` run 29147959791](https://github.com/techno-optimist/p42-prizes/actions/runs/29147959791) passed all four lanes for source release `e54d116f3eebec0e4afba8dea179a8626d42ed35`. The current Git OAuth credential still cannot revise workflow files; future workflow changes need a workflow-capable owner credential or GitHub connector.
