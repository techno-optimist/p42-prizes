...
| Gate 0 | Maintain CI evidence. The reviewed workflow is published, and post-merge [`main` run 29147959791](https://github.com/techno-optimist/p42-prizes/actions/runs/29147959791) for exact release `e54d116f3eebec0e4afba8dea179a8626d42ed35` passed the Python verifier/seed, contract, autonomous-agent, and portal lanes. | Each deploy-relevant release has a completed required-check run against its exact `main` commit. This does not replace protected-release enforcement or private-vulnerability reporting. |
...
- Source control: the CI workflow is published and post-merge
  [`main` run 29147959791](https://github.com/techno-optimist/p42-prizes/actions/runs/29147959791)
  for exact release `e54d116f3eebec0e4afba8dea179a8626d42ed35` passed all four required
