...
| Gate 0 | Maintain CI evidence. The reviewed workflow is published, and post-merge [`main` run 29143160068](https://github.com/techno-optimist/p42-prizes/actions/runs/29143160068) for exact release `43fe77964d33f638655fb27d6f54a5e89c7af18a` passed the Python verifier/seed, contract, autonomous-agent, and portal lanes. | Each deploy-relevant release has a completed required-check run against its exact `main` commit. This does not replace protected-release enforcement or private-vulnerability reporting. |
...
- Source control: the CI workflow is published and post-merge
  [`main` run 29143160068](https://github.com/techno-optimist/p42-prizes/actions/runs/29143160068)
  for exact release `43fe77964d33f638655fb27d6f54a5e89c7af18a` passed all four required
