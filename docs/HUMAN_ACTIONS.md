...
| Gate 0 | Maintain CI and live-release evidence. The reviewed workflow is published, and the schema-validated, canonically sealed [`current source-release receipt`](evidence/source-release-current.json) binds post-merge [`main` run 29328146587](https://github.com/techno-optimist/p42-prizes/actions/runs/29328146587) at observed source head `9a5c45beaa125b686915023add81b0beae5d4cab`, all six required lanes, Render deploy `dep-d9b14cbbc2fs73a3n3h0` at deploy-relevant ancestor `8cfbd366ec206e244aa125535cfca7b7adca4fbb`, and the 10-probe release guard. | Each source release has a completed required-check run and each deploy-relevant release has a release-guard record against its exact `main` commit. This does not replace protected-release enforcement or private-vulnerability reporting. |
...
- Source control: the CI workflow is published and the current
  ...
  binds successful post-merge [`main` run 29328146587](https://github.com/techno-optimist/p42-prizes/actions/runs/29328146587),
