...
- Source control: the CI workflow is published and post-merge
  [`main` run 29165178559](https://github.com/techno-optimist/p42-prizes/actions/runs/29165178559)
  for exact release `0290b89369acf532be83e1a8c71d2eb4516007c5` passed all four required
