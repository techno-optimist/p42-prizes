...
| Gate 0 | Maintain CI and live-release evidence. The reviewed workflow is published, and the schema-validated, canonically sealed [`current source-release receipt`](evidence/source-release-current.json) binds post-merge [`main` run 29343997732](https://github.com/techno-optimist/p42-prizes/actions/runs/29343997732) at observed source head `34dd685080eeb14e00131a021f0cdecd239ee42f`, all six required lanes, Render deploy `dep-d9b3nvr7uimc73a8p1tg` at derived deploy-relevant commit `a6e2f83351b64af5d56ee1a2a9c5e239db45391e`, and the 10-probe release guard. | Each source release has a completed required-check run and each deploy-relevant release has a release-guard record against its exact source/deploy lineage. This does not replace protected-release enforcement or private-vulnerability reporting. |
...
- Source control: the CI workflow is published and the current
  ...
  binds successful post-merge [`main` run 29343997732](https://github.com/techno-optimist/p42-prizes/actions/runs/29343997732),
  all six required lanes, and the live Render release to exact source
  `34dd685080eeb14e00131a021f0cdecd239ee42f`, while the unchanged web runtime remains bound to deploy-relevant commit `a6e2f83351b64af5d56ee1a2a9c5e239db45391e`. Branch protection and rulesets remain blocked by the private-repository
