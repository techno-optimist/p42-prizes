...
| Gate 0 | Maintain CI and live-release evidence. The reviewed workflow is published, and the schema-validated, canonically sealed [`current source-release receipt`](evidence/source-release-current.json) binds post-merge [`main` run 29361335514](https://github.com/techno-optimist/p42-prizes/actions/runs/29361335514) at observed source head `08e911c0311e77837c5449d539749e39adc04f60`, all six required lanes, authenticated API-triggered Render deploy `dep-d9b8349kh4rs73clnvmg` at source commit `eac1fc5c54bd916d8bed16a182830dad0809b9b6` and derived deploy-relevant commit `f544a7af82afdeea1f0dfab6c81acbd7ab4628f8`, and the 10-probe release guard. | Each source release has a completed required-check run and each deploy-relevant release has a release-guard record against its exact source/deploy lineage. This does not replace protected-release enforcement or private-vulnerability reporting. |
...
- Source control: the CI workflow is published and the current
  [`current source-release receipt`](evidence/source-release-current.json)
  binds successful post-merge [`main` run 29361335514](https://github.com/techno-optimist/p42-prizes/actions/runs/29361335514),
  all six required lanes, and the live Render release to exact source
  `08e911c0311e77837c5449d539749e39adc04f60`, while the unchanged web runtime remains bound to deploy-relevant commit `f544a7af82afdeea1f0dfab6c81acbd7ab4628f8` through authenticated API-triggered deploy `dep-d9b8349kh4rs73clnvmg` at source commit `eac1fc5c54bd916d8bed16a182830dad0809b9b6`. Branch protection and rulesets remain blocked by the private-repository
