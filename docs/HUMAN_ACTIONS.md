...
| Gate 0 | Maintain CI evidence. The reviewed workflow is published, and post-merge [`main` run 29138575950](https://github.com/techno-optimist/p42-prizes/actions/runs/29138575950) for exact release `ac6abae58124764d3fbdf951fbee0a6dfc8c7dde` passed the Python verifier/seed, contract, autonomous-agent, and portal lanes. | Each deploy-relevant release has a completed required-check run against its exact `main` commit. This does not replace protected-release enforcement or private-vulnerability reporting. |
...
- Source control: the CI workflow is published and post-merge
  [`main` run 29138575950](https://github.com/techno-optimist/p42-prizes/actions/runs/29138575950)
  for exact release `ac6abae58124764d3fbdf951fbee0a6dfc8c7dde` passed all four required
