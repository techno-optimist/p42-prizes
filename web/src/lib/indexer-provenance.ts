...
export function activatedProvenanceFromArtifacts(
  ...
  if (authorization.schema_version === "p42-production-launch-authorization/v1") {
    throw new Error("launch authorization v1 cannot authorize funding publication");
  }
  throw new Error("no supported launch authorization schema binds legal artifacts and acknowledgement authority");
}
