...
const BOARD_SET_DIGEST = ethers.id("p42-redteam-board-set");
const RELEASE_BINDING_DIGEST = ethers.id("p42-redteam-release-binding");
...
async function deployFixture({
  ...
  const [owner, treasury, resolver, alice, bob, ...authorities] = await ethers.getSigners();
