...
line "$executor" '  --resolver-rerun-user-prefix p42-resolver-rerun- \'
line "$executor" '  --resolver-rerun-attestor-key ${CREDENTIALS_DIRECTORY}/resolver-rerun-attestor-key \'
line "$executor" '  --resolver-rerun-request-root /var/lib/p42/resolver-rerun-requests \'
line "$executor" '  --resolver-rerun-state-root /var/lib/p42/resolver-rerun \'
line "$executor" 'LoadCredential=resolver-rerun-attestor-key:/etc/p42/verifier-executor/credentials/resolver-rerun-attestor-key.json'
